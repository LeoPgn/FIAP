...
public class PrevisaoTempo {
	...
	private static final String API_KEY = "5f099a78f7a82e84291793900efc137g"; //Chave alunos
    ...
    public JSONObject getForecastByCityName(String cityName) throws IOException, JSONException {
    ...
    public JSONObject getForecastByCoord(double latitude, double longitude) throws IOException, JSONException {
